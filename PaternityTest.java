...
public class PaternityTest {
    ...
    public static void main(String[] args) {
        // int[] retInt = possibleFathers( "YDHXMKFWTYWSPGTVDBYG",
        // "ODHXJTFWTHWDPGLSZBEX", new String []{"YMHXMKFHTYOSRGTVDBYG",
        // "YDHSMKQDTYWSOGTVDBYG", "YPHAMKDWOYWSPGTVDUYG",
        // "YDHMMKMWTYJSPXTVDJYG", "YDVXMKZUOYCSPMTVDBYG"});

        int[] retInt = possibleFathers("WXETPYCHUWSQEMKKYNVP",
                "AXQTUQVAUOSQEEKCYNVP", new String[] { "WNELPYCHXWXPCMNKDDXD",
                        "WFEEPYCHFWDNPMKKALIW", "WSEFPYCHEWEFGMPKIQCK",
